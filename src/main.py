...
img = cv2.imread("./img/samples/sample_12_30_half.jpg")
...
img_board, img_no_board, board_center = board_finder.find_board(img)
...
img_board_conf, img_no_board_conf, board_center_conf = board_finder.find_board(img_conf) #se busca el tablero
